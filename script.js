...
const apiKey = '5fc5f7e6eb9ba6ed9f3ee388d3313c10';
...
async function updateWeatherInfo(city) {
    ...
    currentDadeTxt.textContent = getCurrentDate()
    weatherSummerImg.src = `assets/weather/${getWeatherIcon(id)}`
...
function updateForecastItems(weatherData) {
    ...
    const forrecastItem = `
        <div class="forecast-item">
            ...
            <h5 class="forecast-itemp-temp">${Math.round(temp)} ℃</h5>
        </div>
    `
    forecastItemContainer.insertAdjacentHTML('beforeend', forrecastItem)
}

function showDisplaySection(section) {
    [weatherInfoSection, searchCitySecton, notFoundSection]
